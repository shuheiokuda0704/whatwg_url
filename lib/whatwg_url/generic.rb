...
# = Copy and modify uri/generic.rb
#
...
module WhatwgUrl
  ...
  class Generic
    ...
    def self.build(args)
      if args.kind_of?(Array) &&
        args.size == ::WhatwgUrl::Generic::COMPONENT.size
        tmp = args.dup
      elsif args.kind_of?(Hash)
        tmp = ::WhatwgUrl::Generic::COMPONENT.collect do |c|
          if args.include?(c)
            args[c]
          else
            nil
        ...
        component = self.class.component rescue ::WhatwgUrl::Generic::COMPONENT
        raise ArgumentError,
